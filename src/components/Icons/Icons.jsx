    ...
    gitHub: (
      ...
      mail: (
        <svg width="36.000000" height="36.000000" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect rx="-0.500000" width="35.000000" height="35.000000" transform="translate(0.500000 0.500000)" fill-opacity="0"/>
            <g clip-path="url(#clip1386_446)">
                <path d="M6 7.5C5.17 7.5 4.5 8.17 4.5 9L4.5 27C4.5 27.82 5.17 28.5 6 28.5L30 28.5C30.82 28.5 31.5 27.82 31.5 27L31.5 9C31.5 8.17 30.82 7.5 30 7.5L6 7.5ZM1.5 9C1.5 6.52 3.52 4.5 6 4.5L30 4.5C32.47 4.5 34.5 6.52 34.5 9L34.5 27C34.5 29.47 32.47 31.5 30 31.5L6 31.5C3.52 31.5 1.5 29.47 1.5 27L1.5 9Z" fill-opacity="1.000000" fill-rule="evenodd"/>
                <path d="M1.77 8.13C2.24 7.46 3.18 7.29 3.86 7.77L18 17.66L32.13 7.77C32.81 7.29 33.75 7.46 34.22 8.13C34.7 8.81 34.53 9.75 33.86 10.22L18.86 20.72C18.34 21.09 17.65 21.09 17.13 20.72L2.13 10.22C1.46 9.75 1.29 8.81 1.77 8.13Z" fill-opacity="1.000000" fill-rule="evenodd"/>
            </g>
        </svg>
      ),
      mause: (
